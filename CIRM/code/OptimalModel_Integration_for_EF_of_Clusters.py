...
df_original = pd.read_excel("SLM_Ti6Al4V-El-1.xlsx")
...
for index in range(3):
    #每个簇上的样本
    cluster_data = pd.read_excel("cluster_data-El-2.xls",
...
df1 = pd.read_excel("train_El.xlsx")
df = pd.read_excel("test_El.xlsx")
...
for i in range(0, 137):
    ...
    if cluster_index == 0:
        ...
        index2 = "3GPR"
    clf = joblib.load("El_cluster_" + index2+ ".model")
...
predicts1.to_excel("predicts1_El.xlsx")
#放入数据进行分类与预测
target_El = []
predict =[]
predicts = []
