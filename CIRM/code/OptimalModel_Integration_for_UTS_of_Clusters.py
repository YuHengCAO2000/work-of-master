...
df_original = pd.read_excel("SLM_Ti6Al4V-UTS-1.xlsx")
...
for index in range(3):
    #每个簇上的样本
    cluster_data = pd.read_excel("cluster_data-UTS-2.xls",
...
df1 = pd.read_excel("train_UTS.xlsx")
df = pd.read_excel("test_UTS.xlsx")
...
for i in range(0, 137):
    ...
    if cluster_index == 0:
        ...
        index2 = "3GPR"
    clf = joblib.load("UTS_cluster_" + index2+ ".model")
...
predicts1.to_excel("predicts1_UTS.xlsx")
#放入数据进行分类与预测
target_UTS = []
predict = []
predicts = []
